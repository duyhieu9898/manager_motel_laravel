...
class UserController extends Controller
{
    ...
    public function __construct(UserRepositoryInterface $userRepository, AddressService $addressService)
    {
    ...
    public function index()
    {
        ...
        if($userData->address_id !== null) {
            $addressCollection = $this->addressService->getById($userData->address_id);
            $userData->address = formatAddressToString($addressCollection);
        }

        return view('info_user', compact(['userData']));
    }
