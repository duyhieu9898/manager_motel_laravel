...
<body class='page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white dark-sidebar-color logo-dark'>
                                ...
                                <li>
                                    <ul class="dropdown-menu-list small-slimscroll-style" data-handle-color="#637283">
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                    <img src="{{ asset('admin_rooms/img/user/user2.jpg') }}" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                    <img src="{{ asset('admin_rooms/img/user/user3.jpg') }}" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                    <img src="{{ asset('admin_rooms/img/user/user1.jpg') }}" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                    <img src="{{ asset('admin_rooms/img/user/user8.jpg') }}" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                    <img src="{{ asset('admin_rooms/img/user/user5.jpg') }}" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                ...
                                <div class="user-panel">
                                    <div class="row">
                                            <div class="sidebar-userpic">
                                                <img src="{{ asset('admin_rooms/img/dp.jpg') }}" class="img-responsive" alt=""> </div>
                                        </div>
                            ...
                            <div class="chat-sidebar-list">
                                <div class="chat-sidebar-chat-users slimscroll-style" data-rail-color="#ddd" data-wrapper-class="chat-sidebar-list">
                                    ...
                                    <ul class="media-list list-items">
                                        <li class="media"><img class="media-object" src="{{ asset('admin_rooms/img/user/user3.jpg') }}" width="35" height="35" alt="...">
                                        ...
                                        <li class="media">
                                            ...
                                            </div> <img class="media-object" src="{{ asset('admin_rooms/img/user/user1.jpg') }}" width="35" height="35" alt="...">
                                            <i class="busy dot"></i>
                                            <div class="media-body">
                                        ...
                                        <li class="media"><img class="media-object" src="{{ asset('admin_rooms/img/user/user5.jpg') }}" width="35" height="35" alt="...">
                                            <i class="away dot"></i>
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            ...
                                            </div> <img class="media-object" src="{{ asset('admin_rooms/img/user/user4.jpg') }}" width="35" height="35" alt="...">
                                            <i class="online dot"></i>
                                            <div class="media-body">
                                        ...
                                        <li class="media"><img class="media-object" src="{{ asset('admin_rooms/img/user/user2.jpg') }}" width="35" height="35" alt="...">
                                            <i class="busy dot"></i>
                                            <div class="media-body">
                                        ...
                                        <li class="media"><img class="media-object" src="{{ asset('admin_rooms/img/user/user7.jpg') }}" width="35" height="35" alt="...">
                                            <i class="online dot"></i>
                                            <div class="media-body">
                                    ...
                                    <ul class="media-list list-items">
                                        <li class="media">
                                            ...
                                            </div> <img class="media-object" src="{{ asset('admin_rooms/img/user/user6.jpg') }}" width="35" height="35" alt="...">
                                        ...
                                        <li class="media"><img class="media-object" src="{{ asset('admin_rooms/img/user/user8.jpg') }}" width="35" height="35" alt="...">
                                            <i class="offline dot"></i>
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            ...
                                            </div> <img class="media-object" src="{{ asset('admin_rooms/img/user/user9.jpg') }}" width="35" height="35" alt="...">
                                            <i class="offline dot"></i>
                                            <div class="media-body">
                                        ...
                                        <li class="media"><img class="media-object" src="{{ asset('admin_rooms/img/user/user10.jpg') }}" width="35" height="35" alt="...">
                                            <i class="offline dot"></i>
                                            <div class="media-body">
                            ...
                            <div class="chat-sidebar-item">
                                <div class="chat-sidebar-chat-user">
                                    ...
                                    <div class="chat-sidebar-chat-user-messages">
                                        <div class="post out">
                                            <img class="avatar" alt="" src="{{ asset('admin_rooms/img/dp.jpg') }}" />
                                            <div class="message">
                                        ...
                                        <div class="post in">
                                            <img class="avatar" alt="" src="{{ asset('admin_rooms/img/user/user5.jpg') }}" />
                                            <div class="message">
    ...
    <!-- morris chart -->
    {{-- <script src="{{ asset('admin_rooms/plugins/morris/morris.min.js') }}"></script>
    <script src="{{ asset('admin_rooms/plugins/morris/raphael-min.js') }}"></script>
