              ...
              <div class="col-lg-12 user-management">
                    ...
                    <tbody v-if="list_users.length">
                      <tr v-for="(user, index) in list_users" v-bind:key="user.id">
                        ...
                        <td v-if="checkIsAdmin&&!user.isEdit">
                          <button class="btn btn-info" @click="user.isEdit = true"><i class="fa fa-pencil" aria-hidden="true"></i></button>
                          <button class="btn btn-danger" @click="deleteUser(user,index)"><i class="fa fa-trash" aria-hidden="true"></i></button>
                        </td>
                ...
                <div class="create-user" v-if="checkIsAdmin">
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <button class="btn btn-primary" @click="createUser"><i class="fa fa-plus" aria-hidden="true"></i>Create</button>
                    </div>
                  </div>
                </div>
              </div>
