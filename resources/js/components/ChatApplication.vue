<template>
  <div id="frame">
        ...
        <ul>
          <li class="contact active"
            ...
            <div class="wrap">
              ...
              <img src="http://emilcarlsson.se/assets/harveyspecter.png" alt="avatar-user" />
              <div class="meta">
    ...
    <div class="content">
      ...
      <div class="messages" v-show="chatOpen && !loadingMessages">
        <ul ref="messageBox">
          <li v-for="message in messages" :key="message.id" :class="[message.sender_id !== chatUserID ? 'sent' : 'replies']">
            <img src="http://emilcarlsson.se/assets/mikeross.png" alt />
            <div class="d-flex flex-column">
                <span>{{ message.sender.name }} at {{ message.created_at }}</span>
                <p>{{ message.message }} </p>
            </div>
          </li>
        </ul>
      ...
      <div class="message-input">
        <div class="wrap input-group">
          <input class="form-control" type="text" placeholder="Write your message..." v-model="newMessage" />
